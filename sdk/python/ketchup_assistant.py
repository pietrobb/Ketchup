        ...
        if operation_type in {"create_sketch", "create_part"}:
            ...
            if feature.get("type") == "boolean":
                ...
                valid_feature = (
                    ...
                    and 1.0e-6 < abs(distance_mm) <= 1_000_000
