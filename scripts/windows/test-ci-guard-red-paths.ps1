...
try {
    ...
    $rendererSource = Get-Content (Join-Path $repoRoot "crates\ketchup-app\src\renderer.rs") -Raw
    ...
    Write-Utf8NoBom (Join-Path $tempRoot "crates\ketchup-app\src\renderer.rs") $rendererSource
